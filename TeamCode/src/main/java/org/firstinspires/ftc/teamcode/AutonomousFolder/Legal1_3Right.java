...
@Autonomous
public class Legal1_3Right extends LinearOpMode {
...
//CYCLE #1________________________________________________________________________________________
                    ...
                    .waitSeconds(.5)
                    .back(2)
                    .lineToLinearHeading(new Pose2d(-48, 12.5, Math.toRadians(86)))
                    .forward(2)
                    .UNSTABLE_addTemporalMarkerOffset(0, () -> {
                        coneTransporter.setGripperPosition(1.0);
                        coneTransporter.grip();
...
//CYCLE #2_______________________________________________________________________________________
                    ...
                    .lineToLinearHeading(new Pose2d(-59.15, 12.25, Math.toRadians(167.5)))
                    .forward(1)
                    .UNSTABLE_addTemporalMarkerOffset(0, () -> {
...
//CYCLE #3________________________________________________________________________________________
                    ...
                    .lineToLinearHeading(new Pose2d(-59.15, 12.25, Math.toRadians(165)))
                    .forward(1)
                    .UNSTABLE_addTemporalMarkerOffset(0, () -> {
                    ...
                    .lineToLinearHeading(new Pose2d(-34 + (-24 * numericalTag), 15, Math.toRadians(270 - (90 * (Math.min(numericalTag * -1,0) + 1)))), SampleMecanumDrive.getVelocityConstraint(48.0, 3.0, DriveConstants.TRACK_WIDTH), SampleMecanumDrive.getAccelerationConstraint(48.0))
                    .build();
