...
//dropping the preload__________________________________________________________________________
                ...
                .back(4)
                .lineToLinearHeading(new Pose2d(-48.5, 12, Math.toRadians(86)), SampleMecanumDrive.getVelocityConstraint(35.0, 2.5, DriveConstants.TRACK_WIDTH), SampleMecanumDrive.getAccelerationConstraint(35))
                .UNSTABLE_addTemporalMarkerOffset(0, () -> {
                    coneTransporter.setRiseLevel(1);
                    coneTransporter.lift();
                })
...
//CYCLE #1________________________________________________________________________________________
                ...
                .lineToLinearHeading(new Pose2d(-59.4, 12.25, Math.toRadians(170)))
                .forward(1)
                .UNSTABLE_addTemporalMarkerOffset(0, () -> {
                ...
                .waitSeconds(.5)
                .back(2)
                .lineToLinearHeading(new Pose2d(-48.15, 12.5, Math.toRadians(86)))
                .forward(2)
                .UNSTABLE_addTemporalMarkerOffset(0, () -> {
                    coneTransporter.setGripperPosition(1.0);
                    coneTransporter.grip();
...
//CYCLE #2_______________________________________________________________________________________
                ...
                .lineToLinearHeading(new Pose2d(-59.4, 12.25, Math.toRadians(171)))
                .forward(1)
                .UNSTABLE_addTemporalMarkerOffset(0, () -> {
                ...
                .waitSeconds(.5)
                .back(2)
                .lineToLinearHeading(new Pose2d(-48.15, 12.5, Math.toRadians(85)))
                .forward(2)
                .UNSTABLE_addTemporalMarkerOffset(0.0, () -> {
                    coneTransporter.setGripperPosition(1.0);
                    coneTransporter.grip();
...
//CYCLE #3________________________________________________________________________________________
                ...
                .waitSeconds(.5)
                .back(2)
                .lineToLinearHeading(new Pose2d(-48.15, 12.5, Math.toRadians(84)))
                .forward(2)
                .UNSTABLE_addTemporalMarkerOffset(0, () -> {
                    coneTransporter.setGripperPosition(1.0);
                    coneTransporter.grip();
