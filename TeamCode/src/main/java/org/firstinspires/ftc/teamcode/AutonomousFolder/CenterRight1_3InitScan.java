...
@Autonomous
public class CenterRight1_3InitScan extends LinearOpMode {
...
//dropping the preload__________________________________________________________________________
                ...
                .back(4)
                .lineToLinearHeading(new Pose2d(-48, 12, Math.toRadians(86)), SampleMecanumDrive.getVelocityConstraint(35.0, 2.5, DriveConstants.TRACK_WIDTH), SampleMecanumDrive.getAccelerationConstraint(35))
                .UNSTABLE_addTemporalMarkerOffset(0, () -> {
                    coneTransporter.setRiseLevel(1);
                    coneTransporter.lift();
                })
...
//CYCLE #1________________________________________________________________________________________
                ...
                .lineToLinearHeading(new Pose2d(-59.15, 12.25, Math.toRadians(170)))
                .forward(1)
                .UNSTABLE_addTemporalMarkerOffset(0, () -> {
                ...
                .waitSeconds(.5)
                .back(2)
                .lineToLinearHeading(new Pose2d(-47.5, 12.5, Math.toRadians(86)))
                .forward(2)
                .UNSTABLE_addTemporalMarkerOffset(0, () -> {
                    coneTransporter.setGripperPosition(1.0);
                    coneTransporter.grip();
...
//CYCLE #2_______________________________________________________________________________________
                ...
                .lineToLinearHeading(new Pose2d(-59.15, 12.25, Math.toRadians(171)))
                .forward(1)
                .UNSTABLE_addTemporalMarkerOffset(0, () -> {
                ...
                .waitSeconds(.5)
                .back(2)
                .lineToLinearHeading(new Pose2d(-47.5, 12.5, Math.toRadians(85)))
                .forward(2)
                .UNSTABLE_addTemporalMarkerOffset(0.0, () -> {
                    coneTransporter.setGripperPosition(1.0);
                    coneTransporter.grip();
...
//CYCLE #3________________________________________________________________________________________
                ...
                .waitSeconds(.5)
                .back(2)
                .lineToLinearHeading(new Pose2d(-47.5, 12.5, Math.toRadians(84)))
                .forward(2)
                .UNSTABLE_addTemporalMarkerOffset(0, () -> {
                    coneTransporter.setGripperPosition(1.0);
                    coneTransporter.grip();
                ...
                .back(2)
/*//CYCLE #4________________________________________________________________________________________
                .UNSTABLE_addTemporalMarkerOffset(0.5, () -> {
                    coneTransporter.setHeight(0);
                })
                ...
                .lineToLinearHeading(new Pose2d(-34 + (-24 * numericalTag), 15, Math.toRadians(263)), SampleMecanumDrive.getVelocityConstraint(48.0, 3.0, DriveConstants.TRACK_WIDTH), SampleMecanumDrive.getAccelerationConstraint(48.0))
                .back(3)
                .build();
