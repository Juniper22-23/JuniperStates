...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 8.365234615295892; // in; distance between the left and right wheels 213.2/25.4; 8.349709097794658
    public static double FORWARD_OFFSET = 4.78442/25.4; // in; offset of the lateral wheel
