...
@Autonomous
public class CenterLeft1_3InitScan extends LinearOpMode {
...
//dropping the preload__________________________________________________________________________
                ...
                .back(4)
                .lineToLinearHeading(new Pose2d(48, 12, Math.toRadians(90)), SampleMecanumDrive.getVelocityConstraint(35.0, 2.5, DriveConstants.TRACK_WIDTH), SampleMecanumDrive.getAccelerationConstraint(35))
                .UNSTABLE_addTemporalMarkerOffset(0, () -> {
                    coneTransporter.setRiseLevel(1);
                    coneTransporter.lift();
                })
...
//CYCLE #3________________________________________________________________________________________
                ...
                .lineToLinearHeading(new Pose2d(58.15, 11.25, Math.toRadians(356)))
                .forward(1)
                .UNSTABLE_addTemporalMarkerOffset(0, () -> {
