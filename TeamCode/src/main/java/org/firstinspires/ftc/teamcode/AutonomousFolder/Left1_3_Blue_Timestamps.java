...
@Autonomous
public class Left1_3_Blue_Timestamps extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        TrajectorySequence Auto1plus3 = drive.trajectorySequenceBuilder(new Pose2d(startX, startY, startHeading))
                ...
                .UNSTABLE_addTemporalMarkerOffset(0.0, () -> {
                    telemetry.addData("Stopped moving forward at : ", cycleTimer.time(TimeUnit.SECONDS) + " seconds" );
                    timer.reset();
                })
                .UNSTABLE_addTemporalMarkerOffset(.25, () -> {
                    coneTransporter.setGripperPosition(1.0);
                    telemetry.addData("Preload placed at: ", cycleTimer.time(TimeUnit.SECONDS) + " seconds" );
                    timer.reset();
                })
                .waitSeconds(0.65)
                ...
                .UNSTABLE_addTemporalMarkerOffset(0, () -> {
                    coneTransporter.setHeight(ConeTransporter1_5.equate(ConeTransporter1_5.LINEAR_SLIDES_LOW));
                    telemetry.addData("1st cone picked up at: ", cycleTimer.time(TimeUnit.SECONDS) + " seconds" );
                    timer.reset();
                ...
                .UNSTABLE_addTemporalMarkerOffset(.2, () -> {
                    coneTransporter.setGripperPosition(1.0);
                    telemetry.addData("1st cone placed at: ", cycleTimer.time(TimeUnit.SECONDS) + " seconds" );
                    timer.reset();
                ...
                .UNSTABLE_addTemporalMarkerOffset(0, () -> {
                    coneTransporter.setHeight(ConeTransporter1_5.equate(ConeTransporter1_5.LINEAR_SLIDES_LOW));
                    telemetry.addData("2nd cone picked up at: ", cycleTimer.time(TimeUnit.SECONDS) + " seconds" );
                    timer.reset();
                ...
                .UNSTABLE_addTemporalMarkerOffset(0.2, () -> {
                    coneTransporter.setGripperPosition(1.0);
                    telemetry.addData("2nd cone placed at: ", cycleTimer.time(TimeUnit.SECONDS) + " seconds" );
                    timer.reset();
                ...
                .UNSTABLE_addTemporalMarkerOffset(0, () -> {
                    coneTransporter.setHeight(ConeTransporter1_5.equate(ConeTransporter1_5.LINEAR_SLIDES_LOW));
                    telemetry.addData("3rd cone picked up at: ", cycleTimer.time(TimeUnit.SECONDS) + " seconds" );
                    timer.reset();
                ...
                .UNSTABLE_addTemporalMarkerOffset(.2, () -> {
                    coneTransporter.setGripperPosition(1.0);
                    telemetry.addData("3rd cone placed at: ", cycleTimer.time(TimeUnit.SECONDS) + " seconds" );
                    timer.reset();
                ...
                .UNSTABLE_addTemporalMarkerOffset(1, () -> {
                    ...
                    telemetry.addData("Parked at: ", cycleTimer.time(TimeUnit.SECONDS) + " seconds" );
                    timer.reset();
