...
@Autonomous
public class Left1_3_Timestamps extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        TrajectorySequence Auto1plus3 = drive.trajectorySequenceBuilder(new Pose2d(startX, startY, startHeading))
                ...
                .UNSTABLE_addTemporalMarkerOffset(0, () -> {
                    times.add("Stopped Moving forward at: " + telemetryTimer.time(TimeUnit.MILLISECONDS)/1000.0 + " milliseconds" );

                })
                .UNSTABLE_addTemporalMarkerOffset(0, () -> {
                    coneTransporter.setGripperPosition(1.0);
                    times.add("Preload placed at: " +telemetryTimer.time(TimeUnit.MILLISECONDS)/1000.0 + " milliseconds" );
                ...
                .UNSTABLE_addTemporalMarkerOffset(0, () -> {
                    coneTransporter.setGripperPosition(.75);
                    times.add("1st cone picked up at: " + telemetryTimer.time(TimeUnit.MILLISECONDS)/1000.0 + " milliseconds" );
                ...
                .UNSTABLE_addTemporalMarkerOffset(0, () -> {
                    coneTransporter.setGripperPosition(1.0);
                    times.add("1st cone placed at: " +telemetryTimer.time(TimeUnit.MILLISECONDS)/1000.0 + " milliseconds" );
                ...
                .UNSTABLE_addTemporalMarkerOffset(0, () -> {
                    coneTransporter.setGripperPosition(.75);
                    times.add("2nd cone picked up at: " + telemetryTimer.time(TimeUnit.MILLISECONDS)/1000.0 + " milliseconds" );
                ...
                .UNSTABLE_addTemporalMarkerOffset(0, () -> {
                    coneTransporter.setGripperPosition(1.0);
                    times.add("2nd cone placed at: " + telemetryTimer.time(TimeUnit.MILLISECONDS)/1000.0 + " milliseconds" );
                ...
                .UNSTABLE_addTemporalMarkerOffset(0, () -> {
                    coneTransporter.setGripperPosition(.75);
                    times.add("3rd cone picked up at: " + telemetryTimer.time(TimeUnit.MILLISECONDS)/1000.0 + " milliseconds" );
                ...
                .UNSTABLE_addTemporalMarkerOffset(0, () -> {
                    coneTransporter.setGripperPosition(1.0);
                    times.add("3rd cone placed at: " +telemetryTimer.time(TimeUnit.MILLISECONDS)/1000.0 + " milliseconds" );
                ...
                .UNSTABLE_addTemporalMarkerOffset(0, () -> {
                    ...
                    times.add("Parked at: " + telemetryTimer.time(TimeUnit.MILLISECONDS)/1000.0 + " milliseconds" );
